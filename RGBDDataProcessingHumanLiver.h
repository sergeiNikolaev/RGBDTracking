...
#ifndef SOFA_RGBDTRACKING_RGBDDATAPROCESSING_HUMANLIVER_H
#define SOFA_RGBDTRACKING_RGBDDATAPROCESSING_HUMANLIVER_H
...
class RGBDDataProcessingInternalDataHumanLiver
{
public:
};

template<class DataTypes>
class RGBDDataProcessingHumanLiver : public sofa::core::objectmodel::BaseObject
{
public:
    SOFA_CLASS(SOFA_TEMPLATE(RGBDDataProcessingHumanLiver, DataTypes),sofa::core::objectmodel::BaseObject);
    ...
    RGBDDataProcessingHumanLiver();
    virtual ~RGBDDataProcessingHumanLiver();
...
extern template class SOFA_RGBDTRACKING_API RGBDDataProcessingHumanLiver<defaulttype::Vec3Types>;
#endif
